...
export class GamingPage {
  ...
  private gamingNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeGamingNewsSources();
  }
  ...
  initializeGamingNewsSources() {
    this.gamingNewsSources = this.newsCustomization.getFavoriteGamingNewsSources();
  }
  ...
  getNews() {
    this.gamingNewsSources == null || this.gamingNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getGamingNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomGamingNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getGamingNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheGamingNews(news);
  }
