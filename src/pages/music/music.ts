...
export class MusicPage {
  ...
  private musicNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeMusicNewsSources();
  }
  ...
  initializeMusicNewsSources() {
    this.musicNewsSources = this.newsCustomization.getFavoriteMusicNewsSources();
  }
  ...
  getNews() {
    this.musicNewsSources == null || this.musicNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getMusicNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomMusicNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getMusicNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheMusicNews(news);
  }
