...
export class HomePage {
  ...
  private selectedNewsSources: string[];
  ...
  getNews() {
    this.selectedNewsSources == null || this.selectedNewsSources == undefined ? this.getDefaultNews() : this.getCustomizedNews();
  }
