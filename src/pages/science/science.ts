...
export class SciencePage {
  ...
  private scienceNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeScienceNewsSources();
  }
  ...
  initializeScienceNewsSources() {
    this.scienceNewsSources = this.newsCustomization.getFavoriteScienceNewsSources();
  }
  ...
  getNews() {
    this.scienceNewsSources == null || this.scienceNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getScienceNatureNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomScienceNatureNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getScienceNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheScienceNews(news);
  }
