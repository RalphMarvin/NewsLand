...
export class BusinessPage {
  ...
  private businessNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeBusinessNewsSources();
  }
  ...
  initializeBusinessNewsSources() {
    this.businessNewsSources = this.newsCustomization.getFavoriteBusinessNewsSources();
  }
  ...
  getNews() {
    this.businessNewsSources == null || this.businessNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getBusinessNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomBusinessNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getBusinessNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheBusinessNews(news);
  }
