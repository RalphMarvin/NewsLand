...
export class PoliticsPage {
  ...
  private politicsNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializePoliticsNewsSources();
  }
  ...
  initializePoliticsNewsSources() {
    this.politicsNewsSources = this.newsCustomization.getFavoritePoliticsNewsSources();
  }
  ...
  getNews() {
    this.politicsNewsSources == null || this.politicsNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getPoliticsNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomPoliticsNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getPoliticalNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cachePoliticalNews(news);
  }
