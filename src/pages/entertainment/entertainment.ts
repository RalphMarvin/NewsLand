...
export class EntertainmentPage {
  ...
  private entertainmentNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeEntertainmentNewsSources();
  }
  ...
  initializeEntertainmentNewsSources() {
    this.entertainmentNewsSources = this.newsCustomization.getFavoriteEntertainmentNewsSources();
  }
  ...
  getNews() {
    this.entertainmentNewsSources == null || this.entertainmentNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getEntertainmentNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomEntertainmentNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getEntertainmentNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheEntertainmentNews(news);
  }
