...
export class TechnologyPage {
  ...
  constructor(
    ...
    this.initVars();
    this.initializeTechnologyNewsSources();
  }
  ...
  initializeTechnologyNewsSources() {
    this.technologyNewsSources = this.newsCustomization.getFavoriteTechnologyNewsSources();
  }
  ...
  getNews() {
    this.technologyNewsSources == null || this.technologyNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getTechnologyNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomTechnologyNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getTechnologyNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheTechnologyNews(news);
  }
