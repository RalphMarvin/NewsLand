...
export class GeneralPage {
  ...
  private generalNewsSources: string[];
  ...
  constructor(
    ...
    this.initVars();
    this.initializeGeneralNewsSources();
  }
  ...
  initializeGeneralNewsSources() {
    this.generalNewsSources = this.newsCustomization.getFavoriteGeneralNewsSources();
  }
  ...
  getNews() {
    this.generalNewsSources == null || this.generalNewsSources == undefined
      ? this.getDefaultNews()
  ...
  getDefaultNews() {
    if (!this.isConnected) {
      ...
      this.globalNews.getGeneralNews().subscribe(
        newsResults => {
  ...
  getCustomizedNews() {
    if (!this.isConnected) {
      ...
      this.isLoading = true;
      this.customizedNews.getCustomGeneralNews().subscribe(
        newsResults => {
  ...
  getCachedNews() {
    ...
    this.newsCaching.getGeneralNewsCache().then(
      newsData => {
  ...
  cacheNewsData(news: NewsContent) {
    this.newsCaching.cacheGeneralNews(news);
  }
